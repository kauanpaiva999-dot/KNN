-- KN • TDME MARCONE | painel reorganizado

local data = {}
local hpData = {}

-- ===============================
-- TDME MARCONE • PERSONALIZAÇÃO
-- ===============================
local TDME_DISCORD = "https://discord.gg/tdmemarcone"
-- Para mostrar o logo dentro do painel, coloque aqui o ID de uma imagem/decal
-- do Roblox. Exemplo: "rbxassetid://1234567890"
local TDME_LOGO = "rbxassetid://COLOQUE_O_ID_DO_LOGO_AQUI"

local TDME_THEME = {
	Primary = Color3.fromRGB(120, 20, 180),
	Secondary = Color3.fromRGB(215, 80, 255),
	Dark = Color3.fromRGB(10, 10, 10),
}
setclipboard(TDME_DISCORD)

-- Nota: não inclui bypass/anti-detecção de anti-cheat.
...
local tdmeLogo1 = Instance.new("ImageLabel")
tdmeLogo1.Name = "TDMELogo"
tdmeLogo1.Size = UDim2.new(0, 24, 0, 24)
tdmeLogo1.Position = UDim2.new(0, 142, 0, 2)
tdmeLogo1.BackgroundTransparency = 1
tdmeLogo1.Image = TDME_LOGO
tdmeLogo1.ScaleType = Enum.ScaleType.Fit
tdmeLogo1.Parent = hpData.value60
...
UIGradient.Color = ColorSequence.new({
	ColorSequenceKeypoint.new(0, Color3.fromRGB(120, 20, 180)),
...
TextLabel.Text = "TDME MARCONE • SILENT AIM"
...
uiGradient.Color = ColorSequence.new({
	ColorSequenceKeypoint.new(0, Color3.fromRGB(215, 80, 255)),
...
TextButton.TextColor3 = Color3.fromRGB(225, 100, 255)
...
hpData.value63.Color = ColorSequence.new({
	ColorSequenceKeypoint.new(0, Color3.fromRGB(95, 20, 150)),
...
hpData.value62.MouseButton1Click:Connect(function()
	...
	if hpData.value26 then
		...
		hpData.value63.Color = ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.fromRGB(170, 50, 220)),
...
local tdmeLogo2 = Instance.new("ImageLabel")
tdmeLogo2.Name = "TDMELogo"
tdmeLogo2.Size = UDim2.new(0, 24, 0, 24)
tdmeLogo2.Position = UDim2.new(0, 142, 0, 2)
tdmeLogo2.BackgroundTransparency = 1
tdmeLogo2.Image = TDME_LOGO
tdmeLogo2.ScaleType = Enum.ScaleType.Fit
tdmeLogo2.Parent = hpData.value66
...
parent.BackgroundTransparency = 1
parent.Text = "TDME MARCONE • AIMBOT"
parent.TextColor3 = Color3.fromRGB(255, 255, 255)
parent.Font = Enum.Font.GothamBlack
parent.TextSize = 14
...
xButton.TextColor3 = Color3.fromRGB(225, 100, 255)
...
local fxHubSintoniaRpWindow = loadstring(
	game:HttpGet("https://raw.githubusercontent.com/minhdepzai-v/LibraryRobloc/refs/heads/main/RedzLibrary.lua")
)():MakeWindow({
	Title = "KN",
	SubTitle = "TikTok: Alex.cx10q | Discord: https://discord.gg/tdmemarcone",
	SaveFolder = "KN",
})
local button = {
	Image = "rbxassetid://125047611002870",
